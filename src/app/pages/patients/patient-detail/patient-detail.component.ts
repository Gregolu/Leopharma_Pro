...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, RouterLink, FormsModule, PatientMonitoring, PatientNetworkComponent, PatientProtocolComponent, PatientDossierComponent, StudyModalComponent],
