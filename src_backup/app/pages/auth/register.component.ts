  ...
  template: `
    <div class="auth-wrapper flex items-center justify-center">
      <div class="card auth-card flex-col items-center">
        ...
        <h2 class="auth-title">Créer votre espace médical</h2>
        
        <form class="auth-form flex-col gap-4" (ngSubmit)="register()">
          ...
          <button type="submit" class="btn-primary w-full mt-4">S'inscrire</button>
        </form>
