...
.ui-selection-row:hover:not(.disabled) {
  border-color: var(--primary);
  background: #f8fafc;
}
.ui-selection-row.selected {
  border-color: var(--primary);
  background: #f0fdf4;
  color: var(--primary);
}
.ui-selection-row.disabled {
  opacity: 0.5;
  cursor: default;
}
...
.ui-card-small.selected {
  border-color: var(--primary);
  background: #f0fdf4;
  color: var(--primary);
}
.ui-card-small.disabled {
  opacity: 0.5;
  cursor: default;
}
...
.ui-stepper-btn:hover:not([disabled]) {
  border-color: var(--primary);
  color: var(--primary);
}
