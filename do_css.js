...
.ui-card-small { text-align: center; border: 1px solid var(--border); border-radius: 8px; padding: 12px; background: white; cursor: pointer; transition: all 0.2s; color: var(--text-primary); height: 100%; box-sizing: border-box; }
...
.ui-stepper-btn:hover:not([disabled]) { border-color: var(--primary); color: var(--primary); }
